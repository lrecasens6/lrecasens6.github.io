...
# Imágenes
BACKGROUND_IMAGE = 'tetris/FondoTetrisdefinitivo.png'
green_tile = pygame.image.load('tetris/cubo tetris 1.png').convert()
orange_tile = pygame.image.load('tetris/cubo tetris 2.png').convert()
red_tile = pygame.image.load('tetris/cubo tetris 3.png').convert()
yellow_tile = pygame.image.load('tetris/cubo tetris 4.png').convert()
purple_tile = pygame.image.load('tetris/cubo tetris 5.png').convert()
blue_tile = pygame.image.load('tetris/cubo tetris 6.png').convert()
pink_tile = pygame.image.load('tetris/cubo tetris 7.png').convert()
    ...
    for fila in range(0,ALTO):
        for pos in range(0,ANCHO):
            if vista[fila][pos] > 0:
                ...
                y = fila * 20
                if vista[fila][pos] == 1:
                    pantalla.blit(green_tile, ( 220 + x,  y))
                elif vista[fila][pos] == 2:
                    pantalla.blit(orange_tile, (220 + x, y))
                elif vista[fila][pos] == 3:
                    pantalla.blit(red_tile, (220 + x, y))
                elif vista[fila][pos] == 4:
                    pantalla.blit(purple_tile, (220 + x, y))
                elif vista[fila][pos] == 5:
                    pantalla.blit(yellow_tile, (220 + x, y))
                elif vista[fila][pos] == 6:
                    pantalla.blit(blue_tile, (220 + x, y))
                elif vista[fila][pos] == 7:
                    pantalla.blit(pink_tile, (220 + x, y))
...
while not (salir):
    ...
    pantalla.blit(seccion_transparente, (220, 40))
    imprimir_piezas()
